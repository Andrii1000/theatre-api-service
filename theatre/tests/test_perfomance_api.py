...
class PerformanceViewSetTests(APITestCase):
    def setUp(self):
        ...
        self.play = Play.objects.create(
            title="Play", description="Description"
        )
    ...
    def test_retrieve_performance(self):
        ...
        self.assertEqual(response.data["show_time"], "2024-10-15T10:10:00Z")
    ...
    def test_update_performance(self):
        ...
        updated_data = {
            "play": self.play.id,
            "theatre_hall": self.theatre_hall.id,
            "show_time": "2024-10-16T11:11:11Z",
        }
        self.client.force_authenticate(user=self.adminuser)
        ...
        self.assertEqual(str(performance.show_time), "2024-10-16 11:11:11+00:00")
